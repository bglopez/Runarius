...
public class mudclient extends GameConnection {
    ...
    protected Socket createSocket(String addr, int port)
        ...
        // NOTE: we will never start as applet!
            ...
            if (mouseX >= 0 && mouseY >= 0 && mouseX < 468 && mouseY < 262) {
                if (mouseX > 216 && mouseY > 30 && mouseX < 462 && mouseY < 235) {
                    ...
                    if (slot >= 0 && slot < inventoryItemsCount) {
                        ...
                        if (sendUpdate) {
                            super.clientStream.newPacket(Opcodes.Client.CL_TRADE_ITEM_UPDATE.value);
                ...
                if (mouseX >= 217 && mouseY >= 238 && mouseX <= 286 && mouseY <= 259) {
                    tradeAccepted = true;
                    super.clientStream.newPacket(Opcodes.Client.CL_TRADE_ACCEPT.value);
                    super.clientStream.sendPacket();
                }
                if (mouseX >= 394 && mouseY >= 238 && mouseX < 463 && mouseY < 259) {
                    showDialogTrade = false;
                    super.clientStream.newPacket(Opcodes.Client.CL_TRADE_DECLINE.value);
                    super.clientStream.sendPacket();
                }
    ...
    private void sendLogout() {
        ...
        if (combatTimeout > 0) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_LOGOUT.value);
            super.clientStream.sendPacket();
            logoutTimeout = 1000;
            return;
        }
        ...
        if (isSleeping) {
            if (super.inputTextFinal.length() > 0)
                if (super.inputTextFinal.equalsIgnoreCase("::lostcon") && !appletMode)
                    ...
                    super.clientStream.newPacket(Opcodes.Client.CL_SLEEP_WORD.value);
    ...
    private void drawDialogTradeConfirm() {
        ...
        if (mouseButtonClick == 1) {
            ...
            if (super.mouseX >= (dialogX + 118) - 35 && super.mouseX <= dialogX + 118 + 70 && super.mouseY >= dialogY + 238 && super.mouseY <= dialogY + 238 + 21) {
                ...
                super.clientStream.newPacket(Opcodes.Client.CL_TRADE_CONFIRM_ACCEPT.value);
                super.clientStream.sendPacket();
            }
            ...
            if (mouseX >= 0 && mouseY >= 12 && mouseX < 408 && mouseY < 280) {
                ...
                if (slot != -1) {
                    ...
                    if (j1 >= 1 && super.mouseX >= mouseX + 220 && super.mouseY >= mouseY + 238 && super.mouseX < mouseX + 250 && super.mouseY <= mouseY + 249) {
                        super.clientStream.newPacket(Opcodes.Client.CL_BANK_WITHDRAW.value);
                    ...
                    if (getInventoryCount(slot) >= 1 && super.mouseX >= mouseX + 220 && super.mouseY >= mouseY + 263 && super.mouseX < mouseX + 250 && super.mouseY <= mouseY + 274) {
                        super.clientStream.newPacket(Opcodes.Client.CL_BANK_DEPOSIT.value);
                        super.clientStream.putShort(slot);
                        super.clientStream.putShort(1);
                ...
                super.clientStream.newPacket(Opcodes.Client.CL_BANK_CLOSE.value);
                super.clientStream.sendPacket();
                showDialogBank = false;
                return;
            }
            ...
            if (mouseX >= 0 && mouseY >= 0 && mouseX < 468 && mouseY < 262) {
                if (mouseX > 216 && mouseY > 30 && mouseX < 462 && mouseY < 235) {
                    ...
                    if (slot >= 0 && slot < inventoryItemsCount) {
                        ...
                        if (sendUpdate) {
                            super.clientStream.newPacket(Opcodes.Client.CL_DUEL_ITEM_UPDATE.value);
                ...
                if (flag) {
                    super.clientStream.newPacket(Opcodes.Client.CL_DUEL_SETTINGS.value);
                ...
                if (mouseX >= 217 && mouseY >= 238 && mouseX <= 286 && mouseY <= 259) {
                    ...
                    super.clientStream.newPacket(Opcodes.Client.CL_DUEL_ACCEPT.value);
                    super.clientStream.sendPacket();
                }
                if (mouseX >= 394 && mouseY >= 238 && mouseX < 463 && mouseY < 259) {
                    showDialogDuel = false;
                    super.clientStream.newPacket(Opcodes.Client.CL_DUEL_DECLINE.value);
                    super.clientStream.sendPacket();
                }
            } else if (mouseButtonClick != 0) {
                showDialogDuel = false;
            ...
            if (mouseButtonClick == 1 && tabMagicPrayer == 1) {
                ...
                if (l1 != -1) {
                    ...
                    if (GameData.prayerLevel[l1] > l2)
                        ...
                        super.clientStream.newPacket(Opcodes.Client.CL_PRAYER_OFF.value);
                        super.clientStream.putByte(l1);
                        super.clientStream.sendPacket();
                        prayerOn[l1] = false;
                        playSoundFile("prayeroff");
                    } else {
                        super.clientStream.newPacket(Opcodes.Client.CL_PRAYER_ON.value);
                        super.clientStream.putByte(l1);
                        super.clientStream.sendPacket();
                        prayerOn[l1] = true;
    ...
    private void drawDialogShop() {
        if (mouseButtonClick != 0) {
            ...
            if (mouseX >= 0 && mouseY >= 12 && mouseX < 408 && mouseY < 246) {
                ...
                if (shopSelectedItemIndex >= 0) {
                    ...
                    if (itemType != -1) {
                        if (shopItemCount[shopSelectedItemIndex] > 0 && mouseX > 298 && mouseY >= 204 && mouseX < 408 && mouseY <= 215) {
                            ...
                            super.clientStream.newPacket(Opcodes.Client.CL_SHOP_BUY.value);
                        ...
                        if (getInventoryCount(itemType) > 0 && mouseX > 2 && mouseY >= 229 && mouseX < 112 && mouseY <= 240) {
                            ...
                            if (priceMod < 10)
                                priceMod = 10;
                            int itemPrice = (priceMod * GameData.itemBasePrice[itemType]) / 100;
                            super.clientStream.newPacket(Opcodes.Client.CL_SHOP_SELL.value);
                            super.clientStream.putShort(shopItem[shopSelectedItemIndex]);
                            super.clientStream.putInt(itemPrice);
                            super.clientStream.sendPacket();
                        }
                ...
                super.clientStream.newPacket(Opcodes.Client.CL_SHOP_CLOSE.value);
                super.clientStream.sendPacket();
                showDialogShop = false;
                return;
            }
    ...
    private void handleAppearancePanelControls() {
        ...
        if (panelAppearance.isClicked(controlButtonAppearanceAccept)) {
            super.clientStream.newPacket(Opcodes.Client.CL_APPEARANCE.value);
    ...
    private void drawDialogDuelConfirm() {
        ...
        if (mouseButtonClick == 1) {
            ...
            if (super.mouseX >= (dialogX + 118) - 35 && super.mouseX <= dialogX + 118 + 70 && super.mouseY >= dialogY + 238 && super.mouseY <= dialogY + 238 + 21) {
                duelAccepted = true;
                super.clientStream.newPacket(Opcodes.Client.CL_DUEL_CONFIRM_ACCEPT.value);
                super.clientStream.sendPacket();
            }
            if (super.mouseX >= (dialogX + 352) - 35 && super.mouseX <= dialogX + 353 + 70 && super.mouseY >= dialogY + 238 && super.mouseY <= dialogY + 238 + 21) {
                showDialogDuelConfirm = false;
    ...
    private void drawDialogReportAbuseInput() {
        if (super.inputTextFinal.length() > 0) {
            ...
            if (s.length() > 0) {
                ...
                super.clientStream.newPacket(Opcodes.Client.CL_REPORT_ABUSE.value);
    ...
    private void drawDialogCombatStyle() {
        ...
        if (mouseButtonClick != 0) {
            for (int i = 0; i < 5; i++) {
                ...
                combatStyle = i - 1;
                mouseButtonClick = 0;
                super.clientStream.newPacket(Opcodes.Client.CL_COMBAT_STYLE.value);
    ...
    private void menuItemClick(int i) {
        ...
        if (mitemid == 200) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_GROUNDITEM.value);
        ...
        if (mitemid == 210) {
            walkToGroundItem(localRegionX, localRegionY, mx, my, true);
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_GROUNDITEM.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
        ...
        if (mitemid == 300) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_WALLOBJECT.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
        ...
        if (mitemid == 310) {
            walkToWallObject(mx, my, midx);
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_WALLOBJECT.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putByte(midx);
            super.clientStream.putShort(msrcidx);
        ...
        if (mitemid == 320) {
            walkToWallObject(mx, my, midx);
            super.clientStream.newPacket(Opcodes.Client.CL_WALL_OBJECT_COMMAND1.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putByte(midx);
            super.clientStream.sendPacket();
        ...
        if (mitemid == 2300) {
            walkToWallObject(mx, my, midx);
            super.clientStream.newPacket(Opcodes.Client.CL_WALL_OBJECT_COMMAND2.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putByte(midx);
            super.clientStream.sendPacket();
        ...
        if (mitemid == 400) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_OBJECT.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
        ...
        if (mitemid == 410) {
            walkToObject(mx, my, midx, msrcidx);
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_OBJECT.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putShort(mtargetindex);
            super.clientStream.sendPacket();
        ...
        if (mitemid == 600) {
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_INVITEM.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedSpell = -1;
        ...
        if (mitemid == 610) {
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_INVITEM.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedItemInventoryIndex = -1;
        ...
        if (mitemid == 700) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_NPC.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedSpell = -1;
        ...
        if (mitemid == 710) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_NPC.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedItemInventoryIndex = -1;
        ...
        if (mitemid == 725) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_NPC_CMD.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        }
        ...
        if (mitemid == 800) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_PLAYER.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedSpell = -1;
        ...
        if (mitemid == 810) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_USEWITH_PLAYER.value);
            super.clientStream.putShort(midx);
            super.clientStream.putShort(msrcidx);
            super.clientStream.sendPacket();
            selectedItemInventoryIndex = -1;
        ...
        if (mitemid == 805 || mitemid == 2805) {
            ...
            super.clientStream.newPacket(Opcodes.Client.CL_PLAYER_ATTACK.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        }
        if (mitemid == 2806) {
            super.clientStream.newPacket(Opcodes.Client.CL_PLAYER_DUEL.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        }
        if (mitemid == 2810) {
            super.clientStream.newPacket(Opcodes.Client.CL_PLAYER_TRADE.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        }
        if (mitemid == 2820) {
            super.clientStream.newPacket(Opcodes.Client.CL_PLAYER_FOLLOW.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        }
        if (mitemid == 900) {
            walkToActionSource(localRegionX, localRegionY, mx, my, true);
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_GROUND.value);
            super.clientStream.putShort(mx + regionX);
            super.clientStream.putShort(my + regionY);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
        ...
        if (mitemid == 1000) {
            super.clientStream.newPacket(Opcodes.Client.CL_CAST_SELF.value);
            super.clientStream.putShort(midx);
            super.clientStream.sendPacket();
            selectedSpell = -1;
        }
    ...
    protected void handleIncomingPacket(Opcodes.Server packedID, int ptype, int psize, byte pdata[]) {
        try {
            if (packedID == Opcodes.Server.SV_REGION_PLAYERS) {
            ...
            if (packedID == Opcodes.Server.SV_REGION_GROUND_ITEMS) {
                for (int l = 1; l < psize; )
            ...
            if (packedID == Opcodes.Server.SV_REGION_OBJECTS) {
            ...
            if (packedID == Opcodes.Server.SV_INVENTORY_ITEMS) {
                int offset = 1;
            ...
            if (packedID == Opcodes.Server.SV_REGION_PLAYER_UPDATE) {
            ...
            if (packedID == Opcodes.Server.SV_REGION_WALL_OBJECTS) {
            ...
            if (packedID == Opcodes.Server.SV_REGION_NPCS) {
            ...
            if (packedID == Opcodes.Server.SV_REGION_NPC_UPDATE) {
            ...
            if (packedID == Opcodes.Server.SV_OPTION_LIST) {
                showOptionMenu = true;
            ...
            if (packedID == Opcodes.Server.SV_OPTION_LIST_CLOSE) {
                showOptionMenu = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_WORLD_INFO) {
                loadingArea = true;
            ...
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_LIST) {
                int offset = 1;
            ...
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_EQUIPMENT_BONUS) {
                for (int i3 = 0; i3 < playerStatEquipmentCount; i3++)
                    playerStatEquipment[i3] = Utility.getUnsignedByte(pdata[1 + i3]);

                return;
            }
            if (packedID == Opcodes.Server.SV_PLAYER_DIED) {
                deathScreenTimeout = 250;
                return;
            }
            if (packedID == Opcodes.Server.SV_REGION_ENTITY_UPDATE) {
                int j3 = (psize - 1) / 4;
            ...
            if (packedID == Opcodes.Server.SV_APPEARANCE) {
                showAppearanceChange = true;
                return;
            }
            if (packedID == Opcodes.Server.SV_TRADE_OPEN) {
            ...
            if (packedID == Opcodes.Server.SV_TRADE_CLOSE) {
                showDialogTrade = false;
                showDialogTradeConfirm = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_TRADE_ITEMS) {
            ...
            if (packedID == Opcodes.Server.SV_TRADE_RECIPIENT_STATUS) {
                byte byte0 = pdata[1];
                if (byte0 == 1) {
            ...
            if (packedID == Opcodes.Server.SV_SHOP_OPEN) {
                showDialogShop = true;
                int off = 1;
            ...
            if (packedID == Opcodes.Server.SV_SHOP_CLOSE) {
                showDialogShop = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_TRADE_STATUS) {
                byte byte1 = pdata[1];
                if (byte1 == 1) {
                    tradeAccepted = true;
                    return;
            ...
            if (packedID == Opcodes.Server.SV_GAME_SETTINGS) {
            ...
            if (packedID == Opcodes.Server.SV_PRAYER_STATUS) {
            ...
            if (packedID == Opcodes.Server.SV_PLAYER_QUEST_LIST) {
                for (int k4 = 0; k4 < questCount; k4++)
                    questComplete[k4] = pdata[k4 + 1] == 1;

                return;
            }
            if (packedID == Opcodes.Server.SV_BANK_OPEN) {
                showDialogBank = true;
                int l4 = 1;
            ...
            if (packedID == Opcodes.Server.SV_BANK_CLOSE) {
                showDialogBank = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_EXPERIENCE_UPDATE) {
                int i5 = pdata[1] & 0xff;
                playerExperience[i5] = Utility.getUnsignedInt(pdata, 2);
                return;
            }
            if (packedID == Opcodes.Server.SV_DUEL_OPEN) {
            ...
            if (packedID == Opcodes.Server.SV_DUEL_CLOSE) {
                showDialogDuel = false;
                showDialogDuelConfirm = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_TRADE_CONFIRM_OPEN) {
            ...
            if (packedID == Opcodes.Server.SV_DUEL_UPDATE) {
            ...
            if (packedID == Opcodes.Server.SV_DUEL_SETTINGS) {
                if (pdata[1] == 1)
            ...
            if (packedID == Opcodes.Server.SV_BANK_UPDATE) {
                int i6 = 1;
            ...
            if (packedID == Opcodes.Server.SV_INVENTORY_ITEM_UPDATE) {
                int offset = 1;
                int stack = 1;
            ...
            if (packedID == Opcodes.Server.SV_INVENTORY_ITEM_REMOVE) {
            ...
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_UPDATE) {
                int l6 = 1;
            ...
            if (packedID == Opcodes.Server.SV_DUEL_OPPONENT_ACCEPTED) {
                byte byte2 = pdata[1];
                if (byte2 == 1) {
            ...
            if (packedID == Opcodes.Server.SV_DUEL_ACCEPTED) {
                byte byte3 = pdata[1];
                if (byte3 == 1) {
                    duelOfferAccepted = true;
                    return;
            ...
            if (packedID == Opcodes.Server.SV_DUEL_CONFIRM_OPEN) {
            ...
            if (packedID == Opcodes.Server.SV_SOUND) {
                String s = new String(pdata, 1, psize - 1);
                playSoundFile(s);
                return;
            }
            if (packedID == Opcodes.Server.SV_TELEPORT_BUBBLE) {
            ...
            if (packedID == Opcodes.Server.SV_WELCOME) {
            ...
            if (packedID == Opcodes.Server.SV_SERVER_MESSAGE) {
                serverMessage = new String(pdata, 1, psize - 1);
                showDialogServermessage = true;
                serverMessageBoxTop = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_SERVER_MESSAGE_ONTOP) {
                serverMessage = new String(pdata, 1, psize - 1);
                showDialogServermessage = true;
                serverMessageBoxTop = true;
                return;
            }
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_FATIGUE) {
                statFatigue = Utility.getUnsignedShort(pdata, 1);
                return;
            }
            if (packedID == Opcodes.Server.SV_SLEEP_OPEN) {
                if (!isSleeping)
            ...
            if (packedID == Opcodes.Server.SV_PLAYER_STAT_FATIGUE_ASLEEP) {
                fatigueSleeping = Utility.getUnsignedShort(pdata, 1);
                return;
            }
            if (packedID == Opcodes.Server.SV_SLEEP_CLOSE) {
                isSleeping = false;
                return;
            }
            if (packedID == Opcodes.Server.SV_SLEEP_INCORRECT) {
                sleepingStatusText = "Incorrect - Please wait...";
                return;
            }
            if (packedID == Opcodes.Server.SV_SYSTEM_UPDATE) {
            ...
            if (packetErrorCount < 3) {
                ...
                int slen = s1.length();
                super.clientStream.newPacket(Opcodes.Client.CL_PACKET_EXCEPTION.value);
                super.clientStream.putShort(slen);
                super.clientStream.putString(s1);
                super.clientStream.putShort(slen = (s1 = "p-type: " + packedID + "(" + ptype + ") p-size:" + psize).length());
                super.clientStream.putString(s1);
