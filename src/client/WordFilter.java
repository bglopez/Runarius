    ...
    public static void applyTldFilter(char input[], char input1[], char input2[], char tld[], int type) {
        ...
        for (int charIndex = 0; charIndex <= input.length - tld.length; charIndex++) {
            ...
            if (l >= tld.length) {
                ...
                if (DEBUGTLD)
                    System.out.println("Potential tld: " + tld.toString() + " at char " + charIndex + " (type=" + type + ", startmatch=" + startMatch + ", endmatch=" + endMatch + ")");
                ...
                if (flag) {
                    if (DEBUGTLD)
                        System.out.println("Filtered tld: " + tld.toString() + " at char " + charIndex);
                    int l1 = charIndex;
    ...
    public static void applyWordFilter(char input[], char wordlist[], byte charIds[][]) {
        ...
        for (int charIndex = 0; charIndex <= input.length - wordlist.length; charIndex++) {
            ...
            if (k >= wordlist.length) {
                boolean filter = true;
                if (DEBUGTLD)
                    System.out.println("Potential word: " + wordlist.toString() + " at char " + charIndex);
                if (!specialChar) {
                    char prevChar = ' ';
                    if (charIndex - 1 >= 0)
                ...
                if (filter) {
                    if (DEBUGWORD)
                        System.out.println("Filtered word: " + wordlist.toString() + " at char " + charIndex);
